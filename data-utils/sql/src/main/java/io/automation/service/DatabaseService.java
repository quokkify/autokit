...
public class DatabaseService {
   ...
   * Create {@link SqlFactory} for work with SQL databases.
   *
   * @param persistence Persistence class {@link io.automation.persistence.PersistenceItem}
   * @return {@link SqlFactory}
   */
  public SqlFactory createSqlQuery(io.automation.persistence.PersistenceItem persistence) {
